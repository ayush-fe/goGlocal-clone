...
export default function HeadingWithDetails({ currentTheme, data, index }) {
    return <MainContainer currentTheme={currentTheme}>
        <div className="headingAndInfo">
            <div className="mainHeading">{data.mainHeading}</div>
        ...
        <ImageAndInfo key={index} data={data} currentTheme={currentTheme} />
